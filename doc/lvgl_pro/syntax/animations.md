---
url: https://lvgl.io/docs/pro/syntax/animations
title: Animations
---

# Animations

Source: <https://lvgl.io/docs/pro/syntax/animations>
...
Timelines can be defined inside [`<screen>`](https://lvgl.io/screens)s and [`<component>`](https://lvgl.io/components)s.
...
Learn more about it in [Events](https://lvgl.io/events) section.
...
Last updated on
[ConstantsLearn how to define and use constants in LVGL Pro Editor for colors, padding, and other reusable property values.](https://lvgl.io/docs/pro/syntax/constants)[ImagesGuide to using and optimizing images in LVGL Pro Editor.](https://lvgl.io/docs/pro/syntax/images)
