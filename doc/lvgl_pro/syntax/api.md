---
url: https://lvgl.io/docs/pro/syntax/api
title: API
---

# API

Source: <https://lvgl.io/docs/pro/syntax/api>
...
Copy MarkdownOpen
The `<api>` tag can be a child of [`<widget>`](https://lvgl.io/widgets) and [`<component>`](https://lvgl.io/components) tags. Screens don't support custom APIs.
...
<component>
  ...
  <view extends="simple_screen" width="100%">
    ...
    <!-- Add some children to the slot and also change some basic properties -->
    <simple_screen-icon_area style_bg_color="0x333" height="content">
      <lv_image src="img1"/>
      <lv_image src="img2"/>
    </simple_screen-icon_area>

    <!-- Besides a label add a child too -->
    <simple_screen-content_area>
      <style name="style_thin_border"/>
...
Last updated on
[FontsLearn how to use and configure fonts in LVGL Pro Editor.](https://lvgl.io/docs/pro/syntax/fonts)[EventsLearn how to handle and trigger events in LVGL Pro Editor using XML.](https://lvgl.io/docs/pro/syntax/events)
