---
url: https://lvgl.io/docs/pro/syntax/overview
title: Overview
---

# Overview

Source: <https://lvgl.io/docs/pro/syntax/overview>
...
![](https://lvgl.io/docs/pro/_next/image?url=%2Fdocs%2Fpro%2F_next%2Fstatic%2Fmedia%2Feditor_text_editor_popup.0otth190b1_43.png&w=3840&q=75&dpl=dpl_4KXDDm8XbSpXaStTwMsESocnRg7h)
...
To register name-data pairs, see the [Editor Integration](https://lvgl.io/docs/pro/integration) guide.
...
If there is an [`<api>`](https://lvgl.io/api) property like `<prop name="values" type="int[3]"/>` it can be used as `<my_widget values="10 33 55"/>`
...
Last updated on
[IntroductionLearn how LVGL's XML format enables declarative UI development with version control, reusability, and runtime flexibility for embedded applications.](https://lvgl.io/docs/pro/syntax/introduction)[Project FileConfigure your LVGL Pro project with project.xml — set the LVGL version, exported code name, and the display targets used to preview screens.](https://lvgl.io/docs/pro/syntax/project)
