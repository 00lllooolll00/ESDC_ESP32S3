---
url: https://lvgl.io/docs/pro/syntax/preview
title: Preview
---

# Preview

Source: <https://lvgl.io/docs/pro/syntax/preview>

[XML Syntax](https://lvgl.io/docs/pro/syntax)

# Preview
Configure preview settings for components, widgets, and screens to visualize different contexts and resolutions.
Copy MarkdownOpen
...
Last updated on
[TestingLearn how to write and run UI tests in LVGL Pro Editor for quality assurance.](https://lvgl.io/docs/pro/syntax/testing)[XML LicenseLearn the LVGL XML Specification license terms, permitted use cases, and restrictions for UI editors and embedded applications.](https://lvgl.io/docs/pro/syntax/xml-license)
