---
url: https://lvgl.io/docs/pro/syntax/project
title: Project File
---

# Project File

Source: <https://lvgl.io/docs/pro/syntax/project>
...
- `globals.xml` — Defines project-wide fonts, images, subjects, constants, and shared styles. See [Introduction](https://lvgl.io/introduction#shared-resources-with-globalsxml).

- Screens — Use the targets declared here to choose a preview resolution. See [Screens](https://lvgl.io/screens#preview).

- Code export — The `name` attribute controls the exported project name and init function. See [Using Exported C Code](https://lvgl.io/integration/using-exported-c-code).

Last updated on
[OverviewMaster XML syntax rules, naming conventions, and property types used in LVGL Pro Editor for defining UI components.](https://lvgl.io/docs/pro/syntax/overview)[ComponentsLearn about components in LVGL Pro Editor and create reusable UI elements.](https://lvgl.io/docs/pro/syntax/components)
