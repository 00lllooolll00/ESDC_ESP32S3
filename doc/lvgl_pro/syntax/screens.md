---
url: https://lvgl.io/docs/pro/syntax/screens
title: Screens
---

# Screens

Source: <https://lvgl.io/docs/pro/syntax/screens>

[XML Syntax](https://lvgl.io/docs/pro/syntax)

# Screens
Learn how to create and manage screens in LVGL Pro Editor.
Copy MarkdownOpen
...
Last updated on
[WidgetsLearn how to create and use widgets as reusable UI components with XML-based definition and automatic code generation.](https://lvgl.io/docs/pro/syntax/widgets)[ViewLearn how to define the visual structure and layout of components, widgets, screens, and tests using the view tag.](https://lvgl.io/docs/pro/syntax/view)
