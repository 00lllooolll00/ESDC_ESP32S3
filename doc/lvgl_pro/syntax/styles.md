---
url: https://lvgl.io/docs/pro/syntax/styles
title: Styles
---

# Styles

Source: <https://lvgl.io/docs/pro/syntax/styles>
...
See [Data-bindings](https://lvgl.io/data-binding) for more information.
...
However you can pass [`<api>`](https://lvgl.io/api) properties to local style properties:
...
Last updated on
[ViewLearn how to define the visual structure and layout of components, widgets, screens, and tests using the view tag.](https://lvgl.io/docs/pro/syntax/view)[ConstantsLearn how to define and use constants in LVGL Pro Editor for colors, padding, and other reusable property values.](https://lvgl.io/docs/pro/syntax/constants)
