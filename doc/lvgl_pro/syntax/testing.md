---
url: https://lvgl.io/docs/pro/syntax/testing
title: Testing
---

# Testing

Source: <https://lvgl.io/docs/pro/syntax/testing>
...
- UI Definition: Use [`<styles>`](https://lvgl.io/styles), [`<consts>`](https://lvgl.io/constants), and [`<view>`](https://lvgl.io/view) to define
how the UI should look. This is identical to how [`<component>`](https://lvgl.io/components)s are
structured.
...
Last updated on
[TranslationsGuide to implementing multi-language support in LVGL Pro projects.](https://lvgl.io/docs/pro/syntax/translations)[PreviewConfigure preview settings for components, widgets, and screens to visualize different contexts and resolutions.](https://lvgl.io/docs/pro/syntax/preview)
