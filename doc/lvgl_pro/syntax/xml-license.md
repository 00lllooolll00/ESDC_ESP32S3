---
url: https://lvgl.io/docs/pro/syntax/xml-license
title: XML License
---

# XML License

Source: <https://lvgl.io/docs/pro/syntax/xml-license>

[XML Syntax](https://lvgl.io/docs/pro/syntax)

# XML License
Learn the LVGL XML Specification license terms, permitted use cases, and restrictions for UI editors and embedded applications.
Copy MarkdownOpen
...
Last updated on
[PreviewConfigure preview settings for components, widgets, and screens to visualize different contexts and resolutions.](https://lvgl.io/docs/pro/syntax/preview)[Built-in WidgetsXML API reference for every built-in LVGL widget — properties, parameters, elements, shared enums and style properties.](https://lvgl.io/docs/pro/built_in_widgets)
