...
lv_obj_t * volume_slider_create(lv_obj_t * parent)
{
    ...
    lv_obj_set_x(volume_panel, 149);
    lv_obj_set_y(volume_panel, -480);
    lv_obj_set_width(volume_panel, 500);
    lv_obj_set_height(volume_panel, 360);
    ...
    lv_obj_set_style_pad_top(volume_panel, 0, 0);
    ...
    lv_obj_set_y(volume_canel, 286);
    lv_obj_set_width(volume_canel, 70);
    lv_obj_set_height(volume_canel, 40);
    ...
    lv_obj_set_x(volume_slider, 85);
    lv_obj_set_y(volume_slider, 147);
    lv_obj_set_width(volume_slider, 289);
    lv_obj_set_height(volume_slider, 22);
    lv_slider_set_value(volume_slider, 25, false);
    lv_obj_set_style_layout(volume_slider, LV_LAYOUT_FLEX, 0);
